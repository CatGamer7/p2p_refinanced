...
class MinPercentLinearGreedyTest extends TestCaseHelper {
    ...
    void matchRequest() {
        ...
        data = Arrays.asList(new Offer[]{
                ...
                new Offer(1L, testUser, BigDecimal.valueOf(20000), BigDecimal.valueOf(3), OfferStatus.available, 91L, null, null),
                new Offer(2L, testUser, BigDecimal.valueOf(10000), BigDecimal.valueOf(4), OfferStatus.available, 91L, null, null),
                new Offer(3L, testUser, BigDecimal.valueOf(20000), BigDecimal.valueOf(5), OfferStatus.available, 91L, null, null),
        ...
        //Case 2
        data = Arrays.asList(new Offer[]{
                new Offer(0L, testUser, BigDecimal.valueOf(10000), BigDecimal.valueOf(3), OfferStatus.available, 91L, null, null),
                new Offer(1L, testUser, BigDecimal.valueOf(10000), BigDecimal.valueOf(3), OfferStatus.available, 91L, null, null),
                new Offer(2L, testUser, BigDecimal.valueOf(10000), BigDecimal.valueOf(3), OfferStatus.available, 91L, null, null),
                new Offer(3L, testUser, BigDecimal.valueOf(30000), BigDecimal.valueOf(4), OfferStatus.available, 91L, null, null),
                new Offer(4L, testUser, BigDecimal.valueOf(30000), BigDecimal.valueOf(5), OfferStatus.available, 91L, null, null),
        });
