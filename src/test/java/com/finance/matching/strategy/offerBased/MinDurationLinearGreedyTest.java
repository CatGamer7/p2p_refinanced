...
class MinDurationLinearGreedyTest extends TestCaseHelper {
    ...
    void matchRequest() {
        ...
        data = Arrays.asList(new Offer[]{
                new Offer(0L, testUser, BigDecimal.valueOf(20000), BigDecimal.valueOf(5), OfferStatus.available, 30L, null, null),
                new Offer(1L, testUser, BigDecimal.valueOf(20000), BigDecimal.valueOf(5), OfferStatus.available, 30L, null, null),
        ...
        solution = Arrays.asList(new Long[]{0L, 1L, 2L, 3L});
        ...
        data = Arrays.asList(new Offer[]{
                ...
                new Offer(2L, testUser, BigDecimal.valueOf(10000), BigDecimal.valueOf(5), OfferStatus.available, 30L, null, null),
                new Offer(3L, testUser, BigDecimal.valueOf(30000), BigDecimal.valueOf(5), OfferStatus.available, 61L, null, null),
    ...
    protected MatchStrategy getStrategy() {
        return new MinDurationLinearGreedy();
    }
}