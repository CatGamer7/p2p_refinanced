...
create table loan_matches (amount numeric(38,2), status smallint check (status between 0 and 1), fk_offer bigint, fk_proposal bigint, pk_id bigint not null, primary key (pk_id));
...
create table loan_proposal (status smallint check (status between 0 and 1), fk_request bigint, pk_id bigint not null, primary key (pk_id));
